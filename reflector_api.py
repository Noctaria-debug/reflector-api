# reflector_api.py (universal payload handler)
...
async def sync_memory(request: Request, x_api_key: str = Header(None)):
    ...
    try:
        ...
        # 柔軟な受け取り：test / data / emotion / memory / reflection などを統合
        payload = {
        ...
        return {"status": "success", "google_drive": drive_status, "github": github_status}
